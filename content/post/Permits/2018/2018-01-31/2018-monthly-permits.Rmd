...
URL<-url_parse(URL)
URL$parameter= 'state_province=New%20Mexico&min_approved_date=2018-01-01&pagesize=100000'
...
#Be sure to Update Month
URL<-url_parse(URL)
URL$parameter= 'state_province=Texas&min_approved_date=2018-01-01&pagesize=100000'
...
<h4 style="text-align: center;" markdown="1">**January Permitting Activity**</h4>
```{r, echo=F}
map1
```
<br>
...
ggplot(Top20f, aes(x=Top20,fill=Top20))+geom_bar()+scale_fill_manual(values=col)+coord_flip()+hrbrthemes::theme_ipsum()+theme(legend.position = 'none')+ggtitle('Top 20 Operators Permitting Activity in January', subtitle = 'Sourced from DrillingInfo')
