...
```{r}
sold<- st_as_sf(sold)
sold<- sold%>% select(buyers,sellers,Net_Acres, geometry,Year,value___MM_,X__Acre,date_announced)
```
...
sold$colors= rep_len(colors,length.out=200)
```
...
bscols(widths=c(3,NA),list(filter_select('buyers','Acquirer',sd_sold,~buyers),
        filter_slider('date_announced','Date Announced',sd_sold,~date_announced),                   
