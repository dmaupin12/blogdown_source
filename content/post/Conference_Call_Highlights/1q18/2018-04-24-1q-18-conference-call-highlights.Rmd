...
* Guiding 2018 production to average between **13.9-14.8 MMboe,** an increase of **~75%** from the 2017 average. 
    + Increased guidance slightly from fourth quarter due to efficiency gains in drill times and a step-change in number of frac stages completed each month.
...
* Company stated a few **Dean** wells were completed in what was originally thought to be a frac barrier.
    + Recent observations from tests revealed that the **Spraberry Shale** and **Upper Wolfcamp** both appear to be **influenced the the Dean.**
...
* Around **one-third** of wells are being frac'd with local proppant.
<br>
<br>
